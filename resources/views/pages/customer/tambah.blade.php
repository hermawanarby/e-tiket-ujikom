            ...
            <div class="card-body">
                <form action="{{ route('customer.simpan') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" name="nama" id="nama" class="form-control {{$errors->has('nama')?'is-invalid':''}}" value="{{Request::old('nama')}}" required autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <textarea name="alamat" id="alamat" class="form-control {{ $errors->has('alamat') ? 'is-invalid':'' }}" rows="4" required>{{ Request::old('alamat') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="number" id="telepon" name="telepon" class="form-control {{$errors->has('telepon')?'is-invalid':''}}" value="{{Request::old('telepon')}}" required>
