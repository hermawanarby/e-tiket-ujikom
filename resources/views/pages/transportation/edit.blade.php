...
@section('content')
    ...
    <div class="card border-info mb-3">
        <div class="card-header bg-info text-white">Edit Transportasi</div>
            <div class="card-body">
                <form action="{{ route('transportation.update') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" name="kode" id="kode" class="form-control {{$errors->has('kode')?'is-invalid':''}}" value="{{Request::old('kode', $field->code)}}" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" name="deskripsi" id="deskripsi" class="form-control {{$errors->has('deskripsi')?'is-invalid':''}}" value="{{Request::old('deskripsi', $field->description)}}" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <input type="number" name="kapasitas" id="kapasitas" class="form-control {{$errors->has('kapasitas')?'is-invalid':''}}" value="{{Request::old('kapasitas', $field->seat_qty)}}" required>
