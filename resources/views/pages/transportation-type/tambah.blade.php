...
@section('content')
    ...
    <div class="card border-info mb-3">
        <div class="card-header bg-info text-white">Tambah Tipe Pelanggan</div>
            <div class="card-body">
                <form action="{{ route('transportation-type.simpan') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="deskripsi">Deskripsi</label>
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" name="deskripsi" id="deskripsi" class="form-control {{$errors->has('deskripsi')?'is-invalid':''}}" value="{{Request::old('deskripsi')}}" required autofocus>
